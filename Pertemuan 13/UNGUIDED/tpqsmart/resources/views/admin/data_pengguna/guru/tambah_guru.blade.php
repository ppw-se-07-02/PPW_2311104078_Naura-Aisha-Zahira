...
<head>
  ...
  <title>Tambah Pengguna Guru - TPQ Admin</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css">
  <link href="{{ asset('assets/css/admin/dashboard_admin.css') }}" rel="stylesheet">
  <link href="{{ asset('assets/css/admin/data_pengguna/guru/tambah_guru.css') }}" rel="stylesheet">
</head>
<body>
  <!-- Sidebar -->
  ...
  <div class="main-content">
    <div class="container-full">
      ...
      <div class="header-card">
        ...
        <h4 class="header-title">Tambah Pengguna Guru</h4>
      </div>

      <!-- Form -->
      <form id="tambahGuruForm" action="{{ route('admin.guru.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="detail-container">
          <!-- Profile Upload Card -->
          <div class="profile-upload-card">
            <p class="upload-instruction">Upload Foto Profil Guru</p>
          ...
          <div class="form-section">
            ...
            <div class="row mb-3">
              <div class="col-12">
                ...
                <input type="text" class="form-control" name="nama" placeholder="Masukkan nama lengkap guru" required>
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="nip" placeholder="Contoh: 0101" required>
                <small class="form-text"><i class="bi bi-info-circle"></i> ID guru yang unik</small>
              </div>
              <div class="col-md-6">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" name="tempat_lahir" placeholder="Contoh: Temanggung" required>
              </div>
            </div>
            ...
            <div class="row mb-3">
              <div class="col-12">
                ...
                <textarea class="form-control" name="alamat" rows="3" placeholder="Masukkan alamat lengkap guru" required></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="action-buttons">
              ...
              <button type="submit" class="btn btn-primary" id="btnSubmit">
                <i class="bi bi-check-circle"></i> Tambahkan Guru
              </button>
            </div>
          </div>
        </div>
  ...
  <script src="{{ asset('assets/js/admin/data_pengguna/guru/tambah_guru.js') }}"></script>
</body>
</html>